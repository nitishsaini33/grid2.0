        ...
        {importance.length > 0 ? (
          <div className="flex-1 min-h-0">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={importance} layout="vertical" margin={{ top: 0, right: 20, left: 0, bottom: 0 }}>
                <XAxis type="number" stroke="#475569" tickFormatter={(v) => v > 1000 ? (v/1000).toFixed(1)+'k' : v} />
                <YAxis dataKey="feature" type="category" stroke="#94a3b8" width={60} tick={{fontSize: 11}} />
